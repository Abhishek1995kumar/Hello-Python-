...
font_box = tk.Combobox(tool_bar, width=30, textvariable=font_family, state='readonly')
...
## size box
size_var = tk.IntVar()
font_size = tk.Combobox(tool_bar, width=14, textvariable=size_var, state='readonly')
